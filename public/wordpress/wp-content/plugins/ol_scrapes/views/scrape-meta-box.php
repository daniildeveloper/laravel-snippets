		...
		<div class="row">
			<div class="col-md-9">
				<div class="form-horizontal">
					...
					<div class="panel-group">
						...
						<div class="panel" ng-show="model.scrape_type">
							<div class="panel-heading">
								<h4><a href="#collapse-3" data-toggle="collapse"><i class="icon ion-upload"></i><?php _e('Publish Options', 'ol-scrapes'); ?></a></h4>
							</div>
						...
						<div class="panel" ng-show="model.scrape_type">
							<div class="panel-heading">
								<h4><a href="#collapse-4" data-toggle="collapse"><i class="icon ion-funnel"></i><?php _e('Uniqueness Options', 'ol-scrapes'); ?></a></h4>
							</div>
						...
						<div class="panel" ng-show="model.scrape_type">
							<div class="panel-heading">
								<h4><a href="#collapse-5" data-toggle="collapse"><i class="icon ion-calendar"></i><?php _e('Schedule Options', 'ol-scrapes'); ?></a></h4>
							</div>
							...
							<div id="collapse-5" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<div class="form-group" ng-class="{'has-error' : form.scrape_recurrance.$invalid && (form.scrape_recurrance.$dirty || submitted)}" ng-if="model.scrape_type && (model.scrape_run_unlimited || model.scrape_run_limit > 1)">
						...
						<div class="panel" ng-show="model.scrape_type">
							<div class="panel-heading">
								<h4><a href="#collapse-6" data-toggle="collapse"><i class="icon ion-gear-a"></i><?php _e('Other Options', 'ol-scrapes'); ?></a></h4>
							</div>
			...
			<div class="col-md-3">
				<div class="sidebar">
					...
					<div class="action">
						<?php if (empty($_GET['post'])) { ?>
						<button type="submit" name="publish" value="Publish" id="publish" class="btn btn-lg btn-block btn-primary" ng-class="{'disabled' : form.$invalid}" ng-click="submit($event)"><?php _e('Create', 'ol-scrapes'); ?></button>
						<?php } else { ?>
						<button type="submit" name="save" value="Update" id="publish" class="btn btn-lg btn-block btn-primary" ng-class="{'disabled' : form.$invalid}" ng-click="submit($event)"><?php _e('Edit', 'ol-scrapes'); ?></button>
						<?php } ?>
